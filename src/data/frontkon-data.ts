...
export const frontKonData: FrontKonData = {
  ...
  talks: [
    ...
    { id: 't-2026-18', title: l('JavaScript v produkci', 'JavaScript in production'), description: l('Best practices pro psaní a udržování JavaScriptu v produkčních aplikacích. Zkušenosti z reálných projektů a lekce, které jsme se naučili.', 'Best practices for writing and maintaining JavaScript in production applications. Experiences from real projects and lessons we learned.'), speakerId: 'sp-23', topicIds: ['performance'], yearId: '2026', stage: 'C', time: '12:00', language: 'cs', youtubeId: ytPlaceholder },
    { id: 't-2026-19', title: l('Frontend architektura ve velkém měřítku', 'Frontend architecture at scale'), description: l('Jak navrhovat a udržovat frontend architekturu pro velké týmy a projekty. Zkušenosti z vývoje pro Seznam.cz a open-source projektů.', 'How to design and maintain frontend architecture for large teams and projects. Experiences from developing for Seznam.cz and open-source projects.'), speakerId: 'sp-24', topicIds: ['react', 'typescript'], yearId: '2026', stage: 'A', time: '13:00', language: 'cs', youtubeId: ytPlaceholder },
    { id: 't-2026-20', title: l('Socio-technická architektura frontendu', 'Socio-technical frontend architecture'), description: l('Jak navrhovat architekturu, která funguje nejen technicky, ale také pro lidi v týmu. Kombinace technických a sociálních aspektů vývoje softwaru.', 'How to design architecture that works not only technically, but also for people in the team. Combining technical and social aspects of software development.'), speakerId: 'sp-25', topicIds: ['react'], yearId: '2026', stage: 'B', time: '14:00', language: 'en', youtubeId: ytPlaceholder },
